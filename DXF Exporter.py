...
class SketchExporterCommandCreatedHandler(adsk.core.CommandCreatedEventHandler):
    ...
    def notify(self, args):
        try:
            ...
            selInput = inputs.addSelectionInput('sketchSelection', 'Sélectionner des esquisses', 'Sélectionnez des esquisses à exporter')
    ...
    def notify(self, args):
        try:
            ...
            if not selected_sketches:
                ui.messageBox('Aucune esquisse sélectionnée.')
...
class scriptExecuteHandler(adsk.core.CommandCreatedEventHandler):
    ...
    def notify(self, eventArgs: adsk.core.CommandCreatedEventArgs) -> None:
        try:
            ...
            if not cmdDef:
                cmdDef = commandDefinitions.addButtonDefinition('SketchExporter', 'Exporter des esquisses en DXF', 'Sélectionnez des esquisses et exportez-les en fichiers DXF.')
